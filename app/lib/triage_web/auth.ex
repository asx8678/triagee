defmodule TriageWeb.Auth do
  ...
  @read_events ~w(filter timeline-case plot_width scope search select clear-selection review-selected cancel-risk expand queue-toggle density settings close-settings close-inspector dismiss-action-toast manual-close)
