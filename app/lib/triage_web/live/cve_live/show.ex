          ...
          <div id="advisory-workspace" class="cve-workspace">
            <aside class="cve-workspace-side" aria-label="Priority, evidence and intelligence">
              ...
              <section id="cve-intel" class="stack" aria-labelledby="cve-intel-title">
                ...
                <.notice
                  id="cve-intel-banner"
                  kind={if @kev_cache.rows > 0, do: "info", else: "warning"}
                >
                ...
                <p :if={@kev_advisories == []} id="cve-kev-missing" class="supporting">
                  No cached KEV entry for this advisory. Absence is not evidence that it is unexploited.
                </p>
