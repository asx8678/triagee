...
# beam when the module is compiled: runtime configuration cannot flip it, and a
# dev/prod release still cannot reach the network.
config :triage, :collection, loopback_transport: false
